...
## Severity
One of: light / normal / hard.
Record the choice and why it was chosen.
...
### Claim
Quote the exact line from the draft.

### Type
- overclaim
- vague claim
- unsupported claim
- claim that outruns the proof map
...
### Proof status
- supported now
- supportable with existing source material
- not yet supportable
...
- signal doc / message spine / proof map / mechanism brief / comparison brief / page argument shape drafting constraints / anti-slop framework
