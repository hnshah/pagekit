...
## Section 2 — The wrong tool problem
...
**Heading:** Know where you are with every person that matters.
...
*[Placeholder structure — do not publish without real founder examples. The format below shows the kind of specificity needed. Invented names or outcomes should not be used.]*

---

**Example 1 — Fundraising context**

*[Scenario: A founder about to start a fundraise realized she had investor conversations at different stages of warmth but no clear view of which ones were actually warm, which had gone quiet, and which she'd promised a follow-up to. She used [product name] to reconstruct the state of each conversation and identify three investors she'd left on read for over six weeks. Format: brief scenario, what she did, what changed. 2-3 sentences. Real name and company if available.]*

---

**Example 2 — Advisor relationship**

*[Scenario: A founder noticed in [product name] that he hadn't spoken to one of his key advisors in four months, even though he'd been dealing with a product decision the advisor had direct experience with. He reached out, got a 30-minute call that shifted his thinking, and realized he'd been sitting on useful advice he hadn't known to ask for. Format: same as above. Real name and company if available.]*

---

**Example 3 — Customer relationship**

*[Scenario: A founder used [product name] to track her three most important early customers — not their support tickets, but the relationship itself: what they'd asked for, what she'd promised, when she'd last spoken to them, whether they'd heard about the new feature. Format: same as above. Real name and company if available.]*
...
*[Optional: small print on what early access means — waitlist, immediate, invite-only.]*
