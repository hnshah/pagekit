<!--
This file starts as a copy of prompts/06-first-page-draft.md (the canonical prompt for this step).
...
3. Save the raw output to outputs/06-first-page-draft-output.md.
-->
