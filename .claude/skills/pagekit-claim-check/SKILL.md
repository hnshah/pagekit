...
## Read first
- `prompts/07-claim-check.md`
- `frameworks/claim-checking.md`
- `frameworks/anti-slop.md`
...
Invoke the `pagekit-claim-checker` subagent (`.claude/agents/pagekit-claim-checker.md`). Pass:
...
3. **If the same slop pattern showed up more than once,** add it to `frameworks/anti-slop.md` (or strengthen the existing entry) and to `templates/page-argument-shape-template.md`'s drafting-constraints list. The framework absorbs what the claim-check kept catching.
